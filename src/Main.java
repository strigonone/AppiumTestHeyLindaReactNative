...
public class Main {
    ...
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        desiredCapabilities.setCapability("appium:appPackage", "com.meditation.heylinda");
        desiredCapabilities.setCapability("appium:appActivity", "com.meditation.heylinda.MainActivity");
...
//        scroll(ScrollDirection.RIGHT, 0.50);
//        Thread.sleep(1000);
        scroll(ScrollDirection.LEFT, 0.50);
        Thread.sleep(1000);
        scroll(ScrollDirection.DOWN, 0.70);
        Thread.sleep(1000);
        scroll(ScrollDirection.UP, 0.25);
        Thread.sleep(1000);
